...
const Intro = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (!event.target.closest(".fixed-social")) {
  ...
  return (
    <>
      ...
      <div className="relative flex flex-col md:flex-row h-screen w-screen bg-white mt-24 md:mt-0 overflow-hidden">
          ...
          <section className="w-full">
            ...
            <div className="h-auto flex justify-center md:mt-8 md:justify-start items-center px-4 md:px-0 text-left mb-4 md:mb-0 inter-crystal-medium">
              <p>
                ...
                where global trade ambitions become reality. With local
                expertise and international reach, we ensure seamless exports.
                <br />
                Accurate to the core,{" "}
                <span className="inter-crystal-semibold">
                  available 24/7
                </span>{" "}
        ...
        <div className="fixed-social" onClick={toggleSocialIcons}>
          ...
          {showSocialIcons && (
            <div className="social-icons">
              ...
              <img
                ...
                alt="Facebook"
                onClick={() =>
                  openLink("https://www.facebook.com/crystallexim/")
                }
              />
              <img
                src={instagramIcon}
              ...
              <img
                ...
                alt="linkedIn"
                onClick={() =>
                  openLink("http://www.linkedin.com/in/crystalexim")
                }
              />
              <img
                src={telegramIcon}
