...
const Footer = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!formData.email && !formData.contact_no) {
      toast.error("Either Email or Contact Number is required.");
      return;
    }
    ...
    <>
      ...
      >
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-start md:items-center md:space-x-16">
          ...
          <div className="w-full flex flex-col md:w-1/2 justify-center items-center md:items-start mb-8 md:mb-0 inter-crystal-regular text-center">
            <div className="text-center md:text-left">
              ...
              <div className="flex space-x-4 justify-center md:justify-start">
                ...
                <a
                  href="https://linkedln.com/crystallEXIM"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-2xl text-gray-400 hover:text-gren transition duration-300"
                >
        ...
        {/* Divider Line */}
        <hr className="my-8 w-full bg-gren h-0.5 border-0" />
        {/* Bottom Section */}
        <div className="flex flex-col text-center md:flex-row justify-between items-center ibm-plex-mono-semibold">
